...
const CartPage = (props: Props) => {
  ...
  <div className="flex flex-col justify-center h-full">
    {/* Table */}
    <div className="w-full max-w-2xxl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
      ...
      <div className="overflow-x-auto p-3">
        <table className="table-auto w-full">
          ...
          <tbody className="text-sm divide-y divide-gray-100">
            ...
            <tr>
              <td className="p-2">
                <input type="checkbox" className="w-5 h-5" defaultValue="id-1" />
              </td>
              <td className="p-2">
            ...
            <tr>
              <td className="p-2">
                <input type="checkbox" className="w-5 h-5" defaultValue="id-2" />
              </td>
              <td className="p-2">
                <div>
            ...
            <tr>
              <td className="p-2">
                <input type="checkbox" className="w-5 h-5" defaultValue="id-3" />
              </td>
              <td className="p-2">
                <div>
      ...
      <div className="flex justify-end font-bold space-x-4 text-2xl border-t border-gray-100 px-5 py-4">
        <div>Total</div>
        <div className="text-blue-600">RM <span x-text="total.toFixed(2)" /></div>
      </div>
